...
public class JwtTokenUtil implements Serializable {
    ...
    private String secret = "securitysecuritysecuritysecuritysecuritysecuritysecuritysecurity";
...
//   compaction of the JWT to a URL-safe string
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        ...
        return Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.HS512, Keys.hmacShaKeyFor(secret.getBytes())).compact();
    }
